...
plt.plot(n_arr, G2_arr_0    , label = "λ = 0")
plt.plot(n_arr,G2_arr_1    , label = "λ = 1")
plt.plot(n_arr[1:6],G2_arr_50[1:6]   , label = "λ = 50")
plt.plot(n_arr[1:3],G2_arr_1000[1:3], label = "λ = 1000")
plt.yscale("log")
plt.legend()
plt.xlabel("n")
